...
function Login() {
  ...
  localStorage.setItem("token", "attack");
  return (
    <div>
      <Navbar />
      ...
      <section className="h-screen dark:bg-[#040b1e]">
        <div className="flex justify-center items-center flex-wrap h-full g-6 text-gray-800">
          ...
          <div className="dark:shadow-[0px_0px_80px_#00000091] shadow-[2px_2px_40px_#d7d7d7]  p-5 w-[95vw]  sm:w-[32em]  dark:bg-[#030a1d] rounded-xl h-[65vh] md:h-[75vh]">
            <form onSubmit={handleLogin}>
              <FaUserCircle className="text-[5em] mx-auto mt-2 sm:mt-12  dark:[#6892ee]  text-blue-700" />

              <input
                type="email"
                required
                className="block w-full px-4 py-2 mt-10 mb-2 text-xl font-normal dark:bg-[inherit] text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none focus:invalid:border-red-600 valid:border-green-600"
              ...
              <input
                type="password"
                required
                className=" block w-full px-4 py-2 mb-4 mt-2 text-xl font-normal text-gray-700 dark:bg-[inherit] bg-white border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none focus:invalid:border-red-600 valid:border-green-600"
