    ...
    <footer className="text-center  bg-[#000223]  text-white mt-10 border-white border-solid">
      <div className="container px-6 pt-10">
        ...
        <div>
          <form action="">
            <p className=" mb-2">
              <strong>Sign up for my blog updates</strong>
            </p>

            <div className="flex justify-center ">
              <div className="md:mb-1 flex  ">
                <input
                  type="text"
                  className="
                  mx-1
              ...
              "
                ...
                <button
                  type="submit"
                  className=" px-6 py-2 bg-[#eab308] border-2 border-black text-black font-semibold text-sm  uppercase rounded  hover:scale-105 focus:outline-none focus:ring-0 transition duration-150 ease-in-out"
                >
                  Subscribe
                </button>
              </div>
        ...
        <div className="mb-6">
          ...
          <p className="mt-1 text-white ml-4">
            I am thrilled to share my skills, experiences, and achievements with
            you. This website showcases my work and demonstrates my passion for
            my field.If you have any questions or would like to collaborate on a
            project, please feel free to contact me.
          </p>
        </div>

        <div className="mb-6">
          <h5 className="uppercase font-bold mb-1  text-center ">Navigation</h5>
